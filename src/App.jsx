...
export default function App() {
  ...
  const [employees, setEmployees] = useState(JSON.parse(localStorage.getItem('employeeList')) || [{ id: 1, fullName: "Bob Jones", designation: "JavaScript Developer", gender: "male", teamName: "TeamA" },
  { id: 2, fullName: "Jill Bailey", designation: "Node Developer", gender: "female", teamName: "TeamB" },
  ...
  { id: 8, fullName: "Jessiva Faye", designation: "API Developer", gender: "female", teamName: "TeamC" },
  ...
  function handleEmployeeCardClick(event)
    {
      const transformEmployees = employees.map((employee) => employee.id === parseInt(event.currentTarget.id)?(employee.teamName === selectedTeam)?{...employee, teamName:''}:{...employee, teamName: selectedTeam}:employee);
  ...
  return (
    <Router>
        ...
        <Header selectedTeam={selectedTeam} 
          ...
          />
        <Routes>
          <Route path="/" element={<Employees selectedTeam={selectedTeam}
                                              employees={employees}
